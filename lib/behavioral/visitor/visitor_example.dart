...
class VisitorExample extends StatefulWidget {
  const VisitorExample({super.key});

  @override
  State createState() => _VisitorExampleState();
}
  ...
  void _showFilesDialog() {
    ...
    showDialog<void>(
      ...
      builder: (_) => AlertDialog(
        content: SingleChildScrollView(child: Text(filesText)),
        actions: [
          TextButton(
    ...
    return Scaffold(
      body: ScrollConfiguration(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              for (final visitor in visitorsList)
                RadioListTile<int>(
                  title: Text(visitor.getTitle()),
                  value: visitorsList.indexOf(visitor),
                  groupValue: _selectedVisitorIndex,
